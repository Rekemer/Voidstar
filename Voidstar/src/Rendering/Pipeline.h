...
namespace Voidstar
{
	...
	{
	public:
		static UPtr<Pipeline> CreateGraphicsPipeline(GraphicsPipelineSpecification& spec, vk::PrimitiveTopology topology, vk::Format depthFormat, vk::PolygonMode polygonMode = vk::PolygonMode::eFill);
